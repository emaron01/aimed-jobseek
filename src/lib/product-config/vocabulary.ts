...
export const applicationWorkspaceCopy = Object.freeze({
  ...
  jobEditTitle: "Edit posting",
  jobEditHelp:
    "Correct or replace the original pasted posting. Saving regenerates the job requirements.",
  jobEditSave: "Save posting",
  jobEditFailed: "The posting could not be saved.",
  ...
  fitCriterionMet: "Met",
  fitCriterionMissed: "Missed",
  fitCriterionNotStated: "Not stated",
  fitReasonMet: "This criterion is met.",
  fitReasonMissed: "This criterion is missed.",
  fitReasonNotStated: "This criterion is not stated.",
  fitOverrideLabel: "Your override",
  fitScoredLabel: "Scored result",
  fitRescored: "Employer fit was rescored.",
  fitRescoreFailed: "Employer fit could not be rescored.",
  fitOverrideSaved: "Employer-fit override saved.",
  fitOverrideFailed: "The employer-fit override could not be saved.",
  keepWorking:
