...
The line must describe an action the seeker can take in the product right now, in specific terms. Keep it to one or two sentences. Use only the supplied state facts. Do not invent progress, documents, or outcomes. Never mention prompts, sources, confidence, or internal system state.
